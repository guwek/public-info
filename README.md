...
- Methods-focused members have a primary research focus on a) developing new methods in the areas of bioinformatics, medical informatics, data sciences and artificial intelligence with medical applications or b) digital medicine. All methods-focused members shall add the ZDM as an additional affiliation to all relevant publications.

- Application-focused members use digital medicine techniques in their research or clinical practice. Application-focused members are welcome to, but not required to, add the ZDM as an additional affiliation to all publications.

All members are welcome to use the facilities of the ZDM through a system to book rooms and desks (see below).
